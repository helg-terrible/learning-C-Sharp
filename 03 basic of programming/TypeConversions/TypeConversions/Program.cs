...
namespace TypeConversions
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            short answer = (short)Add(numb1, numb2); // явное сужающие приведение с потерей данных
        ...
        {
            Console.WriteLine("-> ключевое слово checked");
            ...
            try
            {
                byte sum = checked((byte)Add(b1, b2)); // checked - проверка на переполнение ариф-й операции
